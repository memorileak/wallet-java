...
/**
 * Thêm một bản ghi thông tin vay nợ
 *
 * @author PAT
 */
public class themkhoanno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 370, 70, -1));

        kieuComboBox.setFont(new java.awt.Font("Corbel", 0, 18)); // NOI18N
        kieuComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cho vay", "Đi vay" }));
        getContentPane().add(kieuComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 370, 110, -1));
        ...
        getContentPane().add(themButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 460, 105, 40));

        jLabel6.setBackground(new java.awt.Color(247, 247, 247));
        jLabel6.setOpaque(true);
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 106, 550, 430));
    ...
    private void themButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_themButtonActionPerformed
        ...
        if (ngayText.getText().length() == 0 || tienText.getText().length() == 0) {
            ...
            Object[] addedRow = new Object[]{
                ...
                kieuComboBox.getSelectedItem().toString(), "Chưa trả"
            };
            if (AuthAPI.isLoggedIn()) {
                ...
                newRecord.put("paid", "0");

                //Thực hiện thêm
                xemthongtindulieu.me.ThemBanGhiNo(addedRow, newRecord);
                this.dispose();
            }
